...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    #default configuration for kconfig
    echo "Default configuration kconfig"
    make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} defconfig

    #Build VM LInux target build
    echo "make all"
...
cd $FINDER_APP_DIR
make clean
make ARCG=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} writer
...
echo "Initramfs stuffs---------------------------------"
echo "Changing root ownership to root"
cd "$OUTDIR/rootfs"
